<%-- 
    ...
    Created on : Jun 22, 2025, 4:43:22 PM
    Author     : admin
--%>
                            ...
                            <div class="col-md-8 mx-auto">
                                <div class="profile-card">
                                    <div class="profile-header text-center py-4">
                                        ...
                                        <h3 class="mt-3"><c:out value="${user.fullName}" /></h3>
                                        <p class="text-muted"><c:out value="${user.role != null ? user.role : 'Unknown'}" /></p>
                                    ...
                                    <div class="profile-body">
                                        ...
                                        <div class="d-flex justify-content-between mt-4">
                                            ...
                                            <a href="${pageContext.request.contextPath}/admin/updateProfile?id=${user.userId}" class="btn btn-custom-primary">
