                    ...
                    <div class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                        ...
                        <div class="position-sticky pt-3">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="${pageContext.request.contextPath}/admin/fix-users">
                                        <i class="bi bi-tools"></i> Fix Users Data
                                    </a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3">
                                <div class="stats-card stats-card-success">
                                    ...
                                    <div class="stats-card-value">876</div>
                                </div>
                            </div>
                            <div class="col-md-3">
