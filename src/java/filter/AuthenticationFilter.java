...
//             path.startsWith("/address") ||  // Allow access to address endpoints
//             path.startsWith("/avatar") ||   // Allow access to avatar endpoints
//             path.equals("/login") ||
...
//                         // Import UserDAO and use it to get user by token
