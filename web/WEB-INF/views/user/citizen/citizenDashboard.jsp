                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <div class="card-body text-center">
                                        ...
                                        <c:choose>
                                            <c:when test="${not empty sessionScope.loggedInUser.householdId}">
                                                <a href="${pageContext.request.contextPath}/household/view?householdId=${sessionScope.loggedInUser.householdId}" class="btn btn-custom-primary w-100 mb-2">View Household</a>
                                            </c:when>
                                            <c:otherwise>
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <div class="card-body text-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/registration/choose" class="btn btn-custom-primary w-100 mb-2">Registration Dashboard</a>
                                        <a href="${pageContext.request.contextPath}/registration/showAll" class="btn btn-custom-secondary w-100">View My Requests</a>
                                    </div>
                                </div>
                            </div>
                        </div>
